...
print("Removed element,", my_linked_list.remove(2))
"Expected: 0x000...."

print("List wo removed element")
my_linked_list.print_list()
"LL: {50, 100, 400}"


"""
Expected: {50, 100, 400} Because it removes the node which index we are setting it for.
"""
