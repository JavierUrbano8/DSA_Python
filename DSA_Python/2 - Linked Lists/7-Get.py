...
"LL: {50, 100}"
print(my_linked_list.get(0), my_linked_list.get(1), my_linked_list.get(2))

my_linked_list.print_list()
"""
Expected: (0x000..., 0x0000..., None) because it returns the node which index we are searching for
